...
def embedding_transformer_default_cropping(cropped_image_size, annotation_type):
    ...
    elif annotation_type == "eye-center":
...
def embedding_transformer(cropped_image_size, embedding, annotation_type, fixed_positions, cropped_positions):
    """
...
def embedding_transformer_160x160(embedding, annotation_type, fixed_positions):
    ...
    return embedding_transformer((160, 160), embedding, annotation_type, fixed_positions, cropped_positions)
...
def embedding_transformer_112x112(embedding, annotation_type, fixed_positions):
    ...
    return embedding_transformer(cropped_image_size, embedding, annotation_type, fixed_positions, cropped_positions)
