...
configuration:
    ...
    $ bob bio pipelines vanilla -v --write-metadata-scores replaymobile-img inception-resnetv2-msceleb

    $ bob bio pipelines vanilla -v --write-metadata-scores my_config/protocol.py replaymobile-img inception-resnetv2-msceleb
"""
