...
# Declaimer: Code mostly inherited from, insightface project at github.

__all__ = [
    "vit_s_dp005_mask_0", # Vit, Small, drop_path_rate 0.05, masking ratio 0.0
    "vit_b_dp005_mask_005", # ViT, base, drop_path_rate 0.05, masking prob 0.05 
    "vit_l_dp005_mask_005" # ViT, large, drop_path_rate 0.05, masking ratio 0.05 
]
...
def vit_s_dp005_mask_0(num_features=512): 
...
def vit_b_dp005_mask_005(num_features=512):
    return VisionTransformer(
...
def vit_l_dp005_mask_005(num_features=512): 
    return VisionTransformer(
