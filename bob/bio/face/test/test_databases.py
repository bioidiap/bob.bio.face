...
def _check_annotations(database, required=True, limit_files=None):
...
def test_ijba():
  ...
  try:
    check_database(database)
    _check_annotations(database, limit_files )
  except IOError as e:
    raise SkipTest("The database could not queried; probably the protocol files are missing. Here is the error: '%s'" % e)
...
def test_lfw():
  ...
  try:
    ...
    check_database(bob.bio.base.load_resource('lfw-unrestricted', 'database', preferred_package='bob.bio.face'), training_depends=True, models_depend=True)
    _check_annotations(database, limit_files=1000)
  except IOError as e:
    raise SkipTest("The database could not queried; probably the db.sql3 file is missing. Here is the error: '%s'" % e)
...
def test_mobio():
  ...
  try:
    ...
    check_database_zt(bob.bio.base.load_resource('mobio-male', 'database', preferred_package='bob.bio.face'), models_depend=True)
    check_database_zt(bob.bio.base.load_resource('mobio-female', 'database', preferred_package='bob.bio.face'), models_depend=True)
  except IOError as e:
    raise SkipTest("The database could not be queried; probably the db.sql3 file is missing. Here is the error: '%s'" % e)
...
def test_multipie():
  ...
  try:
    ...
    check_database_zt(bob.bio.base.load_resource('multipie-pose', 'database', preferred_package='bob.bio.face'), training_depends=True)
  except IOError as e:
    raise SkipTest("The database could not queried; probably the db.sql3 file is missing. Here is the error: '%s'" % e)
