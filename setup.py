...
setup(
    ...
    entry_points={
        ...
        "bob.bio.database": [
            ...
            "tinyface                 = bob.bio.face.config.database.tinyface:database",
            "survface                 = bob.bio.face.config.database.survface:database",
        ...
        "bob.bio.config": [
            ...
            "tinyface                              = bob.bio.face.config.database.tinyface",
            "survface                              = bob.bio.face.config.database.survface",
