...
def test_face_crop_solver():
    ...
    assert isinstance(eyes_norm.cropper, bob.bio.face.preprocessor.FaceEyesNorm)
    assert eyes_norm.cropper.annotation_type == "eyes-center"

    left_profile_norm = bob.bio.face.utils.face_crop_solver(
        cropped_image_size=(CROPPED_IMAGE_HEIGHT, CROPPED_IMAGE_WIDTH),
